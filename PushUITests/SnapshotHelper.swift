...
@objc public class Snapshot: NSObject {
    ...
    public class func setLanguage(app: XCUIApplication) {
    ...
    public class func setLaunchArguments(app: XCUIApplication) {
    ...
    public class func snapshot(name: String, waitForLoadingIndicator: Bool = false) {
    ...
    public class func waitForLoadingIndicatorToDisappear() {
